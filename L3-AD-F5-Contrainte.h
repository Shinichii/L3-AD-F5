...
#define CONTRAINTE_SOMME_INFERIEURE_EGALE 7
#define CONTRAINTE_SOMME_SUPERIEURE_EGALE 8
#define CONTRAINTE_INFERIEURE_EGALE 9
#define CONTRAINTE_SUPERIEURE_EGALE 10
#define CONTRAINTE_SOMME_PONDEREE 11
