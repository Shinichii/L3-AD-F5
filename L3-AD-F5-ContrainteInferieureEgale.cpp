...
ContrainteInferieureEgale::ContrainteInferieureEgale()
{
}
/*
...
*/
bool ContrainteInferieureEgale::contrainteRespectee()
{
...
Pour toutes les variables avant la variable associee, puisque les variables sont dans un ordre decroissant
On retire de leur domaine toutes les valeurs inferieures a var->getValeur()
...
Pour toutes les variables apres la variable associee on retire de leur domaine toutes les valeurs superieures a var->getValeur()
...
*/
bool ContrainteInferieureEgale::reduireDomaines(Variable * var)
{
	bool reduire = false;
...
std::ostream & ContrainteInferieureEgale::afficherCaracteristiques(std::ostream & os)const
{
